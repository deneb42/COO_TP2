...
public class TestProduit {
	...
	public static ArrayList<Produit> populeProduits() {
		...
		p.add(new High_Tech(2, 1099.00f,"MacBookAir", "Un gros paquet de spec de fou"));
		p.add(new Livre(3, 32.20f, "Bilbo le Hobbit", "J.R.R Tolkien", "L'histoire d'un hobbit bien loin de chez lui"));
